...
v2.0で追加された新機能により、ロッドタイプに応じた確率修正が可能になりました。
...
2. World修正(x2): 38.86%  
3. + 釣り人修正(+5): 90.82%
4. + Spot修正(x1.5): 100.00%
5. + Rod修正(=20): 100.00%
```

#### 3倍修正の効果検証
```
修正前: 19.43% → 修正後: 60.18% (約3.1倍)
試行回数: 10,000回での実測値
```
